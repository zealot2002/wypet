...
import com.qh.wypet.databinding.FragmentFollowingBinding
import com.qh.wypet.ui.base.BaseFragment

class FollowingFragment : BaseFragment(), SocialFeedAdapter.SocialFeedInteractionListener {

    private var _binding: FragmentFollowingBinding? = null
    private val binding get() = _binding!!
    
    private lateinit var adapter: SocialFeedAdapter
    private val feedItems = SampleDataProvider.getSampleFollowingData()
